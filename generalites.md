parler de la generalite

mkdir dossier pour crÃ©er un dossier directement a partir de git
...
la commande "touch" crée le fichier dans git
la commande echo"---"> fichier pour créer un titre par exemple dans un fichier
...
git status --ignored pour voir les fichiers supprimÃ©s.
